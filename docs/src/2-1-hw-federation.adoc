...
While the original HelloWorld Federation behavior design was not very strict, for the sake of this tutorial we introduced two interoperability requirements that require specific behavior pattern.
